...
st.dataframe(all_combine_df,width=2400, height=200)
...
st.dataframe(compare_ads_combine_df,width=2400, height=300)
...
st.dataframe(select_ads_combine_df,width=2400, height=600)
